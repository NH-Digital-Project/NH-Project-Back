...
-- ====================================================================
-- 2. 지원서(Application) 데이터 10개 삽입 (모든 날짜 형식 YYYY-MM-DD로 수정 완료)
-- ====================================================================
INSERT IGNORE INTO applications (
    ...
    funding_plan, status, store_link, created_at, updated_at
) VALUES
(1, 1, '김철수', '1990-01-01', '010-1234-5678', '남성', '202605200001',
 '행복농장', '01234', '서울시 강남구', '101호', '123-45-67890', 'AGR-100001', '사과', 50000000, true, true,
 '과일', '2026-09-15', '2026-10-01', '꿀사과', '5kg', 30000, 100,
 '온라인 판로 확대를 위해 지원했습니다.', '사과 재배 및 브랜드 홍보를 위한 펀딩 운영 계획입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),

(2, 2, '이영희', '1985-05-05', '010-9876-5432', '여성', '202605200002',
 '푸른채소농장', '12345', '경기도 수원시', '202호', '098-76-54321', 'AGR-100002', '상추', 30000000, false, false,
 '채소', '2026-08-01', '2026-09-01', '유기농 상추', '1kg', 15000, 200,
 '온라인 판매 경험이 부족하여 신청했습니다.', '친환경 상추 홍보 및 신규 고객 확보를 목표로 합니다.', 'SUBMITTED', null, DATE_SUB(NOW(), INTERVAL 9 DAY), DATE_SUB(NOW(), INTERVAL 9 DAY)),

(3, 3, '박민수', '1978-03-15', '010-1111-2222', '남성', '202605200003',
 '맑은한우농장', '23456', '강원도 횡성군', '본관', '111-22-33333', 'AGR-100003', '한우', 150000000, true, true,
 '축산', '2026-01-01', '2026-11-01', '명품 한우 세트', '2kg', 120000, 50,
 '프리미엄 한우 브랜드 강화를 위해 지원했습니다.', '한우 가공 및 패키지 개선을 위한 펀딩 계획입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),

-- (4, 4, '최지우', '1992-07-21', '010-3333-4444', '여성', '202605200004',
--  '달콤배농원', '34567', '전남 나주시', 'A동', '222-33-44444', 'AGR-100004', '배', 60000000, false, false,
--  '과일', '2026-10-01', '2026-10-31', '나주 신고배', '7.5kg', 45000, 80,
--  '판로 확대와 신규 고객 확보가 필요합니다.', '배 선물세트 구성 및 온라인 홍보를 계획하고 있습니다.', 'CANCELED', null, DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY)),

(5, 5, '정우성', '1980-11-03', '010-5555-6666', '남성', '202605200005',
 '싱싱벌꿀', '45678', '충북 충주시', '1층', '333-44-55555', 'AGR-100005', '벌꿀', 25000000, false, true,
 '식음료', '2026-07-01', '2026-08-01', '천연 아카시아꿀', '1kg', 35000, 150,
 '온라인 판매 채널 확대를 위해 지원했습니다.', '브랜드 홍보와 상세페이지 제작에 활용 예정입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),

(6, 6, '한지민', '1988-10-05', '010-7777-8888', '여성', '202605200006',
 '황금귤농장', '56789', '제주도 서귀포시', '2층', '444-55-66666', 'AGR-100006', '감귤', 80000000, true, true,
 '과일', '2026-11-15', '2026-12-01', '제주 조생감귤', '10kg', 25000, 300,
 '제주 감귤 브랜드 인지도 향상이 목표입니다.', '포장 개선 및 라이브커머스 운영을 계획하고 있습니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)),

(7, 7, '이정재', '1975-02-20', '010-9999-0000', '남성', '202605200007',
 '바른버섯팜', '67890', '충남 부여군', '지하', '555-66-77777', 'AGR-100007', '표고버섯', 40000000, false, false,
 '채소', '2026-09-01', '2026-09-30', '생 표고버섯', '2kg', 28000, 120,
 '안정적인 온라인 판매처 확보가 필요합니다.', '버섯 가공 상품 개발 및 마케팅에 활용 예정입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)),

(8, 8, '송혜교', '1982-11-22', '010-1234-1234', '여성', '202605200008',
 '구수한정미소', '78901', '경기도 이천시', '정미소', '666-77-88888', 'AGR-100008', '쌀', 200000000, true, true,
 '곡물', '2026-10-15', '2026-11-01', '임금님표 이천쌀', '20kg', 65000, 500,
 '브랜드 가치 향상과 신규 고객 확보를 위해 신청했습니다.', '고급 패키지 제작 및 홍보 콘텐츠 제작 계획입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
...
(9, 9, '강동원', '1981-01-18', '010-5678-5678', '남성', '202605200009',
 ...
 '딸기 브랜드 온라인 홍보 확대가 필요합니다.', '신규 패키지 및 체험형 콘텐츠 제작을 계획 중입니다.', 'APPROVED', null, DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)),
...
(10, 10, '유재석', '1972-08-14', '010-1111-5555', '남성', '202605200010',
 ...
 '온라인 판매 경쟁력 강화를 위해 신청했습니다.', '축산물 브랜딩 및 홍보 콘텐츠 제작에 활용 예정입니다.', 'SUBMITTED', null, DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY));
