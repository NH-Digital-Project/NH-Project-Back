...
INSERT IGNORE INTO applications (
    ...
    funding_plan, status, created_at, updated_at
) VALUES
(1, 1, '김철수', '1990-01-01', '010-1234-5678', '남성', '202605200001',
 ...
 '온라인 판로 확대를 위해 지원했습니다.', '사과 재배 및 브랜드 홍보를 위한 펀딩 운영 계획입니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
...
(2, 2, '이영희', '1985-05-05', '010-9876-5432', '여성', '202605200002',
 ...
 '온라인 판매 경험이 부족하여 신청했습니다.', '친환경 상추 홍보 및 신규 고객 확보를 목표로 합니다.', 'SUBMITTED', DATE_SUB(NOW(), INTERVAL 9 DAY), DATE_SUB(NOW(), INTERVAL 9 DAY)),
...
(3, 3, '박민수', '1978-03-15', '010-1111-2222', '남성', '202605200003',
 ...
 '프리미엄 한우 브랜드 강화를 위해 지원했습니다.', '한우 가공 및 패키지 개선을 위한 펀딩 계획입니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
...
(4, 4, '최지우', '1992-07-21', '010-3333-4444', '여성', '202605200004',
 ...
 '판로 확대와 신규 고객 확보가 필요합니다.', '배 선물세트 구성 및 온라인 홍보를 계획하고 있습니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY)),
...
(5, 5, '정우성', '1980-11-03', '010-5555-6666', '남성', '202605200005',
 ...
 '온라인 판매 채널 확대를 위해 지원했습니다.', '브랜드 홍보와 상세페이지 제작에 활용 예정입니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),
...
(6, 6, '한지민', '1988-10-05', '010-7777-8888', '여성', '202605200006',
 ...
 '제주 감귤 브랜드 인지도 향상이 목표입니다.', '포장 개선 및 라이브커머스 운영을 계획하고 있습니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)),
...
(7, 7, '이정재', '1975-02-20', '010-9999-0000', '남성', '202605200007',
 ...
 '안정적인 온라인 판매처 확보가 필요합니다.', '버섯 가공 상품 개발 및 마케팅에 활용 예정입니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)),
...
(8, 8, '송혜교', '1982-11-22', '010-1234-1234', '여성', '202605200008',
 ...
 '브랜드 가치 향상과 신규 고객 확보를 위해 신청했습니다.', '고급 패키지 제작 및 홍보 콘텐츠 제작 계획입니다.', 'APPROVED', DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
