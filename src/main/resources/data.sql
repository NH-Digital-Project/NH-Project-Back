...
(1, 1, '김철수', '1990-01-01', '010-1234-5678', '202605200001', '행복농장', '서울농협', '01234', '서울시 강남구', '101호', '123-45-67890', '사과', 50000000, true, '과일', '2026-09-15', '2026-10-01', '꿀사과', '5kg', 30000, 100, '사과 재배 펀딩', 'SUBMITTED', DATE_SUB(NOW(), INTERVAL 10 DAY), DATE_SUB(NOW(), INTERVAL 10 DAY)),
(2, 2, '이영희', '1985-05-05', '010-9876-5432', '202605200002', '푸른채소농장', '경기농협', '12345', '경기도 수원시', '202호', '098-76-54321', '상추', 30000000, false, '채소', '2026-08-01', '2026-09-01', '유기농 상추', '1kg', 15000, 200, '상추 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 9 DAY), DATE_SUB(NOW(), INTERVAL 9 DAY)),
(3, 3, '박민수', '1978-03-15', '010-1111-2222', '202605200003', '맑은한우농장', '횡성농협', '23456', '강원도 횡성군', '본관', '111-22-33333', '한우', 150000000, true, '축산', '2026-01-01', '2026-11-01', '명품 한우 세트', '2kg', 120000, 50, '한우 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 8 DAY), DATE_SUB(NOW(), INTERVAL 8 DAY)),
(4, 4, '최지우', '1992-07-21', '010-3333-4444', '202605200004', '달콤배농원', '나주농협', '34567', '전남 나주시', 'A동', '222-33-44444', '배', 60000000, false, '과일', '2026-10-01', '2026-10-31', '나주 신고배', '7.5kg', 45000, 80, '배 재배 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 7 DAY), DATE_SUB(NOW(), INTERVAL 7 DAY)),
(5, 5, '정우성', '1980-11-03', '010-5555-6666', '202605200005', '싱싱벌꿀', '충주농협', '45678', '충북 충주시', '1층', '333-44-55555', '벌꿀', 25000000, false, '식음료', '2026-07-01', '2026-08-01', '천연 아카시아꿀', '1kg', 35000, 150, '벌꿀 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 6 DAY), DATE_SUB(NOW(), INTERVAL 6 DAY)),
(6, 6, '한지민', '1988-10-05', '010-7777-8888', '202605200006', '황금귤농장', '제주농협', '56789', '제주도 서귀포시', '2층', '444-55-66666', '감귤', 80000000, true, '과일', '2026-11-15', '2026-12-01', '제주 조생감귤', '10kg', 25000, 300, '감귤 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 5 DAY), DATE_SUB(NOW(), INTERVAL 5 DAY)),
(7, 7, '이정재', '1975-02-20', '010-9999-0000', '202605200007', '바른버섯팜', '부여농협', '67890', '충남 부여군', '지하', '555-66-77777', '표고버섯', 40000000, false, '채소', '2026-09-01', '2026-09-30', '생 표고버섯', '2kg', 28000, 120, '버섯 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 4 DAY), DATE_SUB(NOW(), INTERVAL 4 DAY)),
(8, 8, '송혜교', '1982-11-22', '010-1234-1234', '202605200008', '구수한정미소', '이천농협', '78901', '경기도 이천시', '정미소', '666-77-88888', '쌀', 200000000, true, '곡물', '2026-10-15', '2026-11-01', '임금님표 이천쌀', '20kg', 65000, 500, '이천쌀 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 3 DAY), DATE_SUB(NOW(), INTERVAL 3 DAY)),
(9, 9, '강동원', '1981-01-18', '010-5678-5678', '202605200009', '새콤딸기농원', '논산농협', '89012', '충남 논산시', '비닐하우스', '777-88-99999', '딸기', 70000000, true, '과일', '2026-12-31', '2027-01-01', '설향 딸기', '2kg', 32000, 200, '딸기 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 2 DAY), DATE_SUB(NOW(), INTERVAL 2 DAY)),
(10, 10, '유재석', '1972-08-14', '010-1111-5555', '202605200010', '건강한포크', '도드람농협', '90123', '경기도 안성시', 'A동', '888-99-00000', '돼지고기', 300000000, true, '축산', '2026-01-01', '2026-07-01', '한돈 삼겹살 세트', '3kg', 55000, 400, '한돈 펀딩', 'APPROVED', DATE_SUB(NOW(), INTERVAL 1 DAY), DATE_SUB(NOW(), INTERVAL 1 DAY));
